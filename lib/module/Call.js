...
import { guardNativeEventHandler, NativeModule, NativeEventEmitter } from './common';
...
export class Call extends EventEmitter {
  ...
  constructor({
    ...
    NativeEventEmitter.addListener(Constants.ScopeCall, guardNativeEventHandler(Constants.ScopeCall, this._handleNativeEvent));
  }
  /**
...
(function (_Call2) {
  ...
  _Call2.QualityWarning = QualityWarning;
  let Score;
  (function (Score) {
  ...
  _Call2.Issue = Issue;
  let Listener;
  (function (_Listener) {})(Listener || (Listener = _Call2.Listener || (_Call2.Listener = {})));
})(Call || (Call = {}));
/**
