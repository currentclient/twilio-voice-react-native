...
export class Voice extends EventEmitter {
  ...
  constructor() {
    ...
    NativeEventEmitter.addListener(Constants.ScopeVoice, guardNativeEventHandler(Constants.ScopeVoice, this._handleNativeEvent));
  }
...
(function (_Voice2) {
  ...
  _Voice2.Event = Event;
  let Listener;
  (function (_Listener) {})(Listener || (Listener = _Voice2.Listener || (_Voice2.Listener = {})));
})(Voice || (Voice = {}));
