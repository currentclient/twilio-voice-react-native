...
export class PreflightTest extends EventEmitter {
  ...
  constructor(_uuid) {
    ...
    this._uuid = _uuid;
    common.NativeEventEmitter.addListener(Constants.ScopePreflightTest, common.guardNativeEventHandler(Constants.ScopePreflightTest, this._handleNativeEvent)); // by using a setTimeout here, we let the call stack empty before we flush
