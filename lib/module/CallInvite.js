...
import { guardNativeEventHandler, NativeEventEmitter, NativeModule, Platform } from './common';
...
export class CallInvite extends EventEmitter {
  ...
  constructor({
    ...
    this._to = to;
    this._state = state;
    NativeEventEmitter.addListener(Constants.ScopeCallInvite, guardNativeEventHandler(Constants.ScopeCallInvite, this._handleNativeCallInviteEvent));
  }
...
(function (_CallInvite2) {
  ...
  let Listener;
  (function (_Listener) {})(Listener || (Listener = _CallInvite2.Listener || (_CallInvite2.Listener = {})));
