...
class PreflightTest extends _eventemitter.EventEmitter {
  ...
  constructor(_uuid) {
    ...
    this._uuid = _uuid;
    common.NativeEventEmitter.addListener(_constants.Constants.ScopePreflightTest, common.guardNativeEventHandler(_constants.Constants.ScopePreflightTest, this._handleNativeEvent)); // by using a setTimeout here, we let the call stack empty before we flush
