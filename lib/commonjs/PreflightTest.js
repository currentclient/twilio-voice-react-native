...
class PreflightTest extends _eventemitter.EventEmitter {
  ...
  constructor(_uuid) {
    ...
    this._uuid = _uuid;
    common.NativeEventEmitter.addListener(_constants.Constants.ScopePreflightTest, common.guardNativeEventHandler(_constants.Constants.ScopePreflightTest, this._handleNativeEvent));
...
function parseCallQualityIos(nativeCallQuality) {
  ...
  if (typeof parsedCallQuality !== 'string') {
    throw new _error.InvalidStateError(`Call quality invalid. Expected one of "Excellent", "Great", "Good", ` + `"Fair", "Degraded", found "${nativeCallQuality}".`);
  }
  return parsedCallQuality;
}
...
(function (_PreflightTest2) {
  ...
  _PreflightTest2.Event = Event;
  let Listener;
  (function (_Listener) {})(Listener || (Listener = _PreflightTest2.Listener || (_PreflightTest2.Listener = {})));
  let State;
  (function (State) {
  ...
  _PreflightTest2.CallQuality = CallQuality;
  /**
...
const callQualityMap = {
  ...
  ios: new Map([['Excellent', PreflightTest.CallQuality.Excellent], ['Great', PreflightTest.CallQuality.Great], ['Good', PreflightTest.CallQuality.Good], ['Fair', PreflightTest.CallQuality.Fair], ['Degraded', PreflightTest.CallQuality.Degraded]]),
