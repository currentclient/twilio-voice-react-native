...
class CallInvite extends _eventemitter.EventEmitter {
  ...
  constructor({
    ...
    this._to = to;
    this._state = state;
    _common.NativeEventEmitter.addListener(_constants.Constants.ScopeCallInvite, (0, _common.guardNativeEventHandler)(_constants.Constants.ScopeCallInvite, this._handleNativeCallInviteEvent));
  }
