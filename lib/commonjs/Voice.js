...
class Voice extends _eventemitter.EventEmitter {
  ...
  constructor() {
    ...
    _common.NativeEventEmitter.addListener(_constants.Constants.ScopeVoice, (0, _common.guardNativeEventHandler)(_constants.Constants.ScopeVoice, this._handleNativeEvent));
  }
