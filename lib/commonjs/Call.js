...
class Call extends _eventemitter.EventEmitter {
  ...
  constructor({
    ...
    _common.NativeEventEmitter.addListener(_constants.Constants.ScopeCall, (0, _common.guardNativeEventHandler)(_constants.Constants.ScopeCall, this._handleNativeEvent));
  }
  /**
