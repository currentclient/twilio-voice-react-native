...
class OutgoingCallMessage extends _IncomingCallMessage.IncomingCallMessage {
  ...
  constructor({
    ...
    _common.NativeEventEmitter.addListener(_constants.Constants.ScopeCallMessage, (0, _common.guardNativeEventHandler)(_constants.Constants.ScopeCallMessage, this._handleNativeEvent));
  }
}
...
(function (_OutgoingCallMessage2) {
  let Event;
  (function (Event) {
    Event["Failure"] = "failure";
    Event["Sent"] = "sent";
  })(Event || (Event = {}));
  _OutgoingCallMessage2.Event = Event;
  let Listener;
  (function (_Listener) {})(Listener || (Listener = _OutgoingCallMessage2.Listener || (_OutgoingCallMessage2.Listener = {})));
